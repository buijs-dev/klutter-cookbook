...
extension WelcomeButton on BuildContext {
  Widget get sayHelloButton => MyOutlinedButton(
      text: 'Say Hello',
      onPressed: () {
        Navigator.of(this).push(MaterialPageRoute<Welcome>(
...
extension on BuildContext {
  Future<void> showWelcomeDialog(String greeting) async =>
      showDialog<void>(
          context: this,
          ...
          builder: (BuildContext context) => AlertDialog(
            backgroundColor: Colors.indigoAccent,
              ...
              content: Text(greeting, style: TextStyle(color: Colors.white70),),
              actions: <Widget>[
                MyOutlinedButton(
                    text: 'Close',
                    onPressed: () => Navigator.of(context).pop()),
